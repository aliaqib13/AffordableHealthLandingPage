...
const CompareHealth = () => {
  return (
    <div className='  grid md:grid-cols-2 grid-cols-1 gap-5  py-10 w-[90%] mx-auto'>
      <div className=' bg-[#F6F8F7]  rounded-md md:p-10 p-5 text-center w-full '>
        ...
        <div className=" flex md:flex-row flex-col gap-4 justify-center my-6 ">
          ...
          <div className=" flex justify-center items-center py-4 bg-pink-800 rounded-[10px] px-10 text-2xl font-medium text-white hover:bg-slate-500 cursor-pointer">
            Start My Quote
          </div>
        </div>
      </div>
